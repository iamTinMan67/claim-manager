...
FROM exhibits
WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'exhibits');
...
-- Step 4: Show sample data from both tables
...
-- Step 5: Check if there are any evidence records that look like they came from exhibits
