-- Phase 1: Prepare case_number to be primary identifier
...
-- Phase 2: Create new tables with case_number as foreign key
...
-- Phase 3: Migrate data from old tables to new tables
...
-- Phase 5: Update claims table to use case_number as primary key
...
-- Phase 6: Create updated database functions
...
-- Phase 7: Enable RLS and create policies for new tables
