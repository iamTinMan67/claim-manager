...
-- The claim_shares table doesn't have can_edit_evidence column, so we'll simplify
...
-- Recreate a simplified function that works with the existing claim_shares table structure
