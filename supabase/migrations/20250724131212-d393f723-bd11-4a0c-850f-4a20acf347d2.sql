-- Drop and recreate the junction tables with correct types

-- Drop the tables that have foreign key references
DROP TABLE IF EXISTS claim_shares CASCADE;
DROP TABLE IF EXISTS evidence_claims CASCADE;
DROP TABLE IF EXISTS pending_evidence CASCADE;
DROP TABLE IF EXISTS chat_messages CASCADE;

-- Recreate claim_shares with text claim_id
...
-- Recreate evidence_claims with text claim_id
...
-- Recreate pending_evidence with text claim_id
...
-- Recreate chat_messages with text claim_id
