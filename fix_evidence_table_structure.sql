-- =====================================================
-- FIX EVIDENCE TABLE STRUCTURE
-- Run this in your Supabase SQL Editor
-- =====================================================

-- 1. Drop and recreate the evidence table with correct structure
DROP TABLE IF EXISTS evidence CASCADE;

-- 2. Create evidence table with proper structure
...
SELECT 'Evidence table structure fixed successfully!' as status;
