...
const SubscriptionManager = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* FAQ Section */}
      <div className="card-enhanced p-6">
        <h3 className="text-lg font-semibold text-gold mb-4">Frequently Asked Questions</h3>
        <div className="space-y-4">
          <div>
            <h4 className="font-medium text-gold">Can I change my plan anytime?</h4>
            <p className="text-sm text-gold-light mt-1">
              Yes, you can upgrade or downgrade your plan at any time. Changes take effect immediately.
            </p>
          </div>
          <div>
            <h4 className="font-medium text-gold">What happens to my data if I downgrade?</h4>
            <p className="text-sm text-gold-light mt-1">
              Your data is never deleted. If you exceed limits, you'll need to upgrade or remove content to continue adding new items.
            </p>
          </div>
          <div>
            <h4 className="font-medium text-gold">What features are included for free?</h4>
            <p className="text-sm text-gold-light mt-1">
              Text, chat and even a drawing board completely FREE! Upload, share and store information in the cloud.
            </p>
          </div>
          <div>
            <h4 className="font-medium text-gold">How does guest pricing work?</h4>
            <p className="text-sm text-gold-light mt-1">
