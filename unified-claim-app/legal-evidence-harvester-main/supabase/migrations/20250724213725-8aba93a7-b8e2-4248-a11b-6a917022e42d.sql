-- Complete migration from UUID-based claims to case_number-based claims
...
-- Step 6: Migrate claim_shares data (matching old UUID claim IDs to case_numbers)
...
JOIN public.claims c ON cs.claim_id = c.id::text;
